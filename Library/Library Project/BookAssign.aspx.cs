...
public partial class BookAssign : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        lblresult_bookassign.Visible = false;
    }
    protected void btn_Assign_Click(object sender, EventArgs e)
    {
        if (txt_assign_bookid.Text != "" && txt_assign_studentid.Text != "")
        {
            try
            {
                ...
                cmd.ExecuteNonQuery();
                con.Close();
                lblresult_bookassign.Text = "Book ID : " + txt_assign_bookid.Text + " is assigned to Student ID : " + txt_assign_studentid.Text + " on the Date of : " + txt_assign_bookdate.Text + " and you have to return on Date : " + returndate;
                lblresult_bookassign.Visible = false;
               // ScriptManager.RegisterStartupScript(this, GetType(), "alertMessage", "alter('Book ID: " + txt_assign_bookid.Text + " is assigned to Student ID: " + txt_assign_studentid.Text + "\nOn the Date of: " + txt_assign_bookdate.Text + " and you have to return on Date: " + returndate + "');", true);
                ScriptManager.RegisterStartupScript(this, GetType(), "alertMessage", "alert('"+lblresult_bookassign.Text.Trim()+"');", true);
